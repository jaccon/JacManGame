...
function JacMan(id,params){

    var gameSong = {
        value: 10,
        audio: './sounds/game.mp3'
    };
    
    var audioElement = playSong(gameSong); // load song and play it
